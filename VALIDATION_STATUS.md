...
controlled/uncontrolled, and exact/Monte Carlo compiled-cost evaluation. The
local regression suite reports `202 passed` in the documented Python 3.11
environment. This remains implementation evidence only; no H3--H14 scientific
baseline was regenerated by this change.
